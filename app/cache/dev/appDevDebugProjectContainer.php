...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'phpcommerce.payment.gateway.configuration_service_provider' => 'getPhpcommerce_Payment_Gateway_ConfigurationServiceProviderService',
    ...
    {
        return $this->services['cache_warmer'] = new \Symfony\Component\HttpKernel\CacheWarmer\CacheWarmerAggregate(array(0 => new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TranslationsCacheWarmer($this->get('translator')), 1 => new \Symfony\Bridge\Doctrine\CacheWarmer\ProxyCacheWarmer($this->get('doctrine'))));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_sqlite', 'path' => (__DIR__.'/test.db'), 'host' => 'localhost', 'port' => NULL, 'user' => 'root', 'password' => NULL, 'driverOptions' => array()), $b, $c, array());
    }
    ...
    {
        $a = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array(($this->targetDirs[4].'/Resources/config/doctrine') => 'PHPCommerce\\Payment\\Entity'));
        $a->setGlobalBasename('mapping');

        $b = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $b->addDriver($a, 'PHPCommerce\\Payment\\Entity');

        $c = new \Doctrine\ORM\Configuration();
        $c->setEntityNamespaces(array('Payment' => 'PHPCommerce\\Payment\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_92489202334fd034bf7efec3600874b3082b96f6ccc9ce904bf3469672ca76b3');
    ...
    /**
     * Gets the 'phpcommerce.payment.gateway.configuration_service_provider' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \PHPCommerce\Payment\Service\PaymentGatewayConfigurationServiceProviderImpl A PHPCommerce\Payment\Service\PaymentGatewayConfigurationServiceProviderImpl instance.
     */
    protected function getPhpcommerce_Payment_Gateway_ConfigurationServiceProviderService()
    {
        return $this->services['phpcommerce.payment.gateway.configuration_service_provider'] = new \PHPCommerce\Payment\Service\PaymentGatewayConfigurationServiceProviderImpl();
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'PHPCommercePaymentBundle' => 'PHPCommerce\\PaymentBundle\\PHPCommercePaymentBundle',
            ),
